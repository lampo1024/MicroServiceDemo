...
namespace MicroServiceDemo.ProductService.Services
{
    public class ConsulHostedService : IHostedService
    {
        ...
        public ConsulHostedService(IConsulClient consulClient, IOptions<ConsulConfig> consulConfig, ILogger<ConsulHostedService> logger, IServer server, IConfiguration configuration)
        {
            _server = server;
            _logger = logger;
